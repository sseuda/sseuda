...
CREATE TABLE IF NOT EXISTS tbl_user_role (
    ...
    user_role ENUM('admin', 'user') DEFAULT 'user' COMMENT '회원 권한',
...
VALUES
    ('COMMENT', '2번 회원님이 회원님의 게시글에 댓글을 남겼습니다.', 1, 1, 1, NULL, '2025-01-05 10:20:00'),
    ('COMMENT', '3번 회원님이 회원님의 게시글에 댓글을 남겼습니다.', 1, 1, 2, NULL, '2025-01-05 10:21:00'),
    ('COMMENT', '4번 회원님이 회원님의 게시글에 댓글을 남겼습니다.', 2, 2, 3, NULL, '2025-01-06 11:00:00'),
    ('COMMENT', '5번 회원님이 회원님의 게시글에 댓글을 남겼습니다.', 3, 3, 4, NULL, '2025-01-07 12:00:00'),
    ('COMMENT', '1번 회원님이 회원님의 게시글에 댓글을 남겼습니다.', 4, 4, 5, NULL, '2025-01-08 13:00:00'),
    ('COMMENT', '2번 회원님이 회원님의 게시글에 댓글을 남겼습니다.', 5, 5, 6, NULL, '2025-01-09 14:00:00'),
    ('COMMENT', '3번 회원님이 회원님의 게시글에 댓글을 남겼습니다.', 6, 6, 7, NULL, '2025-01-10 15:00:00'),
    ('COMMENT', '4번 회원님이 회원님의 게시글에 댓글을 남겼습니다.', 7, 7, 8, NULL, '2025-01-11 16:00:00'),
    ('COMMENT', '5번 회원님이 회원님의 게시글에 댓글을 남겼습니다.', 3, 8, 9, NULL, '2025-01-12 17:00:00'),
    ('COMMENT', '2번 회원님이 회원님의 게시글에 댓글을 남겼습니다.', 5, 10, 10, NULL, '2025-01-13 18:00:00'),
    ('LIKE', '2번 회원님이 회원님의 게시글을 좋아합니다.', 1, 1, NULL, 1, '2025-01-05 10:15:00'),
    ('LIKE', '1번 회원님이 회원님의 게시글을 좋아합니다.', 2, 2, NULL, 2, '2025-01-06 12:20:00'),
    ('LIKE', '4번 회원님이 회원님의 게시글을 좋아합니다.', 3, 3, NULL, 3, '2025-01-07 14:00:00'),
    ('LIKE', '3번 회원님이 회원님의 게시글을 좋아합니다.', 4, 4, NULL, 4, '2025-01-08 09:30:00'),
    ('LIKE', '6번 회원님이 회원님의 게시글을 좋아합니다.', 5, 5, NULL, 5, '2025-01-09 11:45:00'),
    ('LIKE', '5번 회원님이 회원님의 게시글을 좋아합니다.', 6, 6, NULL, 6, '2025-01-10 15:10:00'),
    ('LIKE', '7번 회원님이 회원님의 게시글을 좋아합니다.', 7, 7, NULL, 7, '2025-01-11 17:25:00'),
    ('LIKE', '8번 회원님이 회원님의 게시글을 좋아합니다.', 3, 8, NULL, 8, '2025-01-12 19:50:00'),
    ('LIKE', '9번 회원님이 회원님의 게시글을 좋아합니다.', 4, 9, NULL, 9, '2025-01-13 21:00:00'),
    ('LIKE', '10번 회원님이 회원님의 게시글을 좋아합니다.', 5, 10, NULL, 10, '2025-01-14 22:30:00');
